...
export const Ingredients = ({
	...
	const [playOnDrag] = useSound("/sounds/pick-up.mp3", {
		volume: 0.25,
	});

	const [playOnDragEnd] = useSound("/sounds/put-down.mp3", {
		volume: 0.85,
	});
				...
				if (item && item !== IngredientType.EMPTY) {
					...
					return (
						<animated.div
							...
							onMouseDown={() => playOnDrag()}
							onMouseUp={() => deletedOriginalIndex && playOnDragEnd()}
						>
							<span
								style={{
									height: "100%",
